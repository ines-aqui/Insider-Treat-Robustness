...
| `3-1__attack_generation.py` | Earlier attack generation script (v6 methods). |
| `3-2__attack_generation.py` | Final attack generation with 6 attack methods: `global_only_multistart`, `local_only_multistart`, `shap_multistart`, `global_linesearch`, `local_only_linesearch`, `shap_linesearch`. |
...
|--------|-------------------|-----------------|
| `global_only_multistart` | Global SHAP top-K | Random multi-start |
| `local_only_multistart` | Local SHAP top-M | Random multi-start |
| `shap_multistart` | Union of global + local (rank-weighted) | Random multi-start |
| `global_linesearch` | Global SHAP top-K | ± direction × step grid |
| `local_only_linesearch` | Local SHAP top-M | ± direction × step grid |
| `shap_linesearch` | Union of global + local (rank-weighted) | ± direction × step grid |
